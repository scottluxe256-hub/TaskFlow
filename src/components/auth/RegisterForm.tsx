    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-2 gap-2.5">
        <button
          ...
          className="py-2 px-3 rounded-xl border font-bold text-xs flex items-center justify-center gap-2 transition cursor-pointer shadow-sm hover:shadow-md border-slate-300 bg-white hover:bg-slate-50 text-slate-800"
        >
